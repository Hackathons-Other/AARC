...
export (PoolColorArray) var function_colors = PoolColorArray([
	Color("ff3232"),
	Color("f7ba2b"),
	Color("28f7a5"),
	Color("2bbaff")
	])
export (Color) var v_lines_color: Color = Color.white
export (Color) var h_lines_color: Color = Color.white

export (bool) var boxed: bool = true
export (Color) var box_color: Color = Color.white
...
var point_node: PackedScene = preload("res://addons/easy_charts/Utilities/Point/point.tscn")
